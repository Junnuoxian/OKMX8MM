...
Require-Literal $contents['config/a53-demo.conf.example'] 'status=/mnt/sdcard/status.json' 'config/a53-demo.conf.example'
...
Require-Literal $contents['docs/protocol-guide.md'] '发现跳号或乱序时' 'docs/protocol-guide.md'
...
Require-Literal $contents['docs/protocol-guide.md'] 'runtime-data/a53-status.json' 'docs/protocol-guide.md'
Require-Literal $contents['docs/protocol-guide.md'] '"error":"sequence_gap"' 'docs/protocol-guide.md'
